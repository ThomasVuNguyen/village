...
export const themeConfig: ThemeConfig = {
  // SITE INFO ///////////////////////////////////////////////////////////////////////////////////////////
  site: {
    website: 'https://village.comfyspace.tech', // Site domain (update when deployed)
    title: 'Village', // Site title
    author: 'Thomas the Maker', // Author name
    description: 'Village, the portal to allow computers to communicate through the internet', // Site description
